...
public class Common {
    ...
    public static final String LOGIN_ENT = "LOGIN_ENT";
    ...
    public static String createBlock(Object[] ids)
    {
        ...
        {
            strbuf.append("'").append(str[i]).append("',");
            //blockStr += "'" + str[i] + "',";
        }

        strbuf.append("'").append(str[str.length - 1]).append("'");
