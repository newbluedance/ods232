...
<body>
	<div class="box2" panelTitle="查询" id="searchPanel">
	    <form action="<%=request.getContextPath()%>/hisInfo/hisInfoCheckConentList" id="queryForm" method="post">
	        <table>
	            <tr>
	...
	<script type="text/javascript">
	         ...
	         g = $("#maingrid").quiGrid({
	            columns: [
	                ...
	                { display: '制作商', name: 'maker',   align: 'center', width: "10%" ,isSort:false},
	                 ...
	                 { display: '审核时间', name: 'checkDateH', align: 'center', width: "10%",isSort:false},	
	                  { display: '审核人', name: 'checkNameH', align: 'center', width: "10%",isSort:false},	 
	                ...
	                { display: '操作', isAllowHide: false, align: 'center', width: "8%",
	                    ...
	                    render: function (rowdata, rowindex, value, column){
	                    	...
	                    	}else if(rowdata.stateH=='2' || rowdata.stateH=='3'){
	            ...
	            url: '<%=request.getContextPath()%>/hisInfo/hisInfoCheckConentList',
	            pageSize: 10,
	            sortName: '',
	            rownumbers:true,
	            checkbox:false,
	    ...
	    function toCheckDetail(proId) {
	        ...
	        //top.Dialog.open({URL: "<%=request.getContextPath()%>/hisInfo/toCheckDetail?proId="+proId,Title: "查看",Width: 960,Height: 450});
	    }
		
	    //到审核界面 
	    function toCheckUpdate(proId) {
	    	window.location.href="<%=request.getContextPath()%>/hisInfo/toCheckUpdate?proId="+proId;
	    }
