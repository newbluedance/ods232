...
<body>
	<div id='handlerDiv' class="box1" whiteBg="true">
		...
		<input id="staId" name="staId" type="hidden" value="${staId }"/>
		...
		<div style="position: absolute;top: 250px;left: 30px" id="cateringFile_div" align="left"></div>
	</div>
    ...
    function cateringPictureImgUp() {
		...
		$.ajaxFileUpload({
			...
			data: {tabName:"${staId }",tabFileName:"cateringFile",companyFlag:"Y"},
