...
<body>
	<div id='mainDiv' class="box1" whiteBg="true">
		<form action="<%=request.getContextPath()%>/expects/updateExpects" id="updateForm" method="post" failAlert="表单填写不正确，请按要求填写！">
		<input id="exId" name="exId" type="hidden" value="${expects.exId}"/>
			<table class="tableStyle" formMode="view" >
				<tr>
					<td>人员：</td>
					<td><input id="expectName" name="expectName" type="text" value="${expects.expectName}"/></td>
					<td>电话：</td>
					<td><input id="phone" name="phone" type="text" value="${expects.phone}"/></td>
				</tr>
				<tr>
					<td>单位：</td>
					<td><input id="dept" name="dept" type="text" value="${expects.dept}"/></td>
					<td></td><td></td>
				</tr>
			</table>
		</form>
