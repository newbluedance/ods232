...
<div class="box1" id="formContent" whiteBg="true">
    <form action="<%=request.getContextPath()%>/role/doUpdate" id="createForm" method="post">
        <input type="text" name="roleId" value="${roleId}" />
        <table class="tableStyle" formMode="transparent">
            <tr>
                <td width="150">角色名：</td>
                <td><input type="text" id="roleName" name="roleName" value="${roleName}" class="validate[required]"/><span
                        class="star">*</span></td>
            </tr>
            <tr>
                <td>角色描述：</td>
                <td><input type="text" id="roleDesc" name="roleDesc" value="${roleDesc}" class="validate[required]"/><span
                        class="star">*</span></td>
            </tr>
            <%--<tr>
                <td>所属项目：</td>
