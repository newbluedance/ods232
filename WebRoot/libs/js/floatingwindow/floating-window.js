...
************************************************************************************************************/
	...
	var imgContextPath = '';
 	function initContextPath() {
    	$A(document.getElementsByTagName("script")).findAll( function(s) {return (s.src && s.src.match(/floating-window\.js(\?.*)?$/))}).each( function(s) {var path = s.src.replace(/floating-window\.js(\?.*)?$/,''); imgContextPath = imgContextPath == null ? './' : path;});
	}
	...
	*/	
	...
	function createNewWindow(width,height,left,top)
	{
		...
		img.src = imgContextPath + 'images/top_left.gif';
		img.align='left';
		topDiv.appendChild(img);
		
		var img = document.createElement('IMG');
		img.src = imgContextPath + 'images/top_center.gif';
		...
		var img = document.createElement('IMG');
		img.src = imgContextPath + 'images/minimize.gif';
		img.className='minimizeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = imgContextPath + 'images/close.gif';
		img.className='closeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = imgContextPath + 'images/top_right.gif';
		buttonDiv.appendChild(img);		
		...
		var img = document.createElement('IMG');
		img.src = imgContextPath + 'images/bottom_right.gif';
