                ...
                <div id="bs_navright">
                    <div class="bs_nav">
                        ...
                        <div class="float_right padding_top2 padding_right5">
                            <a href="<%=request.getContextPath()%>/system/modern_accordion/open.jsp" target="frmright" onclick='backHome()'><span class="icon_home hand">首页</span></a>
                    ...
                    <div id="lbox_middleleft">
                        <div id="lbox_middleright">
                            <div id="bs_left" style="width:100%;">
                                <IFRAME height="100%" width="100%"  frameBorder=0 id=frmleft name=frmleft src="<%=request.getContextPath()%>/system/modern_accordion/left.jsp"  allowTransparency="true"></IFRAME>
                            </div>
                    ...
                    <div id="rbox_middlecenter">
                        <div id="rbox_middleleft">
                            <div id="rbox_middleright">
                                <div id="bs_right">
                                    <IFRAME height="100%" width="100%" frameBorder=0 id=frmright name=frmright src="<%=request.getContextPath()%>/system/modern_accordion/open.jsp"  allowTransparency="true"></IFRAME>
                                </div>
                            </div>
                        </div>
                    </div>
