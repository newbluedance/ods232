...
<head>
    ...
    <script type="text/javascript">
        var zNodes = [
            { id: 3001, parentId: 0, name: "航空配餐", iconOpen: "skin/titlebar_arrow_up.png", iconClose: "skin/titlebar_arrow_down.png", icon: "skin/titlebar_arrow_right.png", iconSkin: "diy01"},
            { id: 101, parentId: 3001, name: "配餐申请", url: "<%=request.getContextPath()%>/catering/toApplyList", target: "frmright", iconOpen: "<%=request.getContextPath()%>/libs/icons/tree_close.gif", iconClose: "<%=request.getContextPath()%>/libs/icons/tree_open.gif", icon: "skin/titlebar_arrow.gif"},
            { id: 102, parentId: 3001, name: "修改密码", url: "<%=request.getContextPath()%>/catering/toUpdatePassword", target: "frmright", iconOpen: "<%=request.getContextPath()%>/libs/icons/tree_close.gif", iconClose: "<%=request.getContextPath()%>/libs/icons/tree_open.gif", icon: "skin/titlebar_arrow.gif"}
        ];
    </script>
</head>
